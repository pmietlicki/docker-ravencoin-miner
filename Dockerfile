...
RUN useradd -ms /bin/bash ravencoin
USER ravencoin
WORKDIR /home/ravencoin
COPY --from=build --chown=ravencoin /root/xmrig/build/xmrig /home/ravencoin
